...
var ae={
  ...
  crack: ()=>{ tone(.1,'square').f(220,120,100).v(.5,.6,.3); tone(.15,'square').f(120,80,100).v(.2,.3,.5,.3);},
  flt_in: ()=> {tone(.5).f(150,220,150,250,150).v(.1,.2,.1,.2,.1,.2,.1,.2,0);},
  flt_out: ()=> {tone(.5).f(150,220,150,250,150).v(.1,.2,.1,.2,.1,.2,.1,.2,0);},
  bounce: ()=>{ tone(.33).f(420,440).v(.1,.3,.3,.3,.2,.1,0); },
